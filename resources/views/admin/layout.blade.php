          ...
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start list-sidebar" id="menu">
            ...
            @endif
              ...
              <li class="nav-item">
                  ...
                  @if (request()->is(['panel/admin/settings', 'panel/admin/settings/limits', 'panel/admin/video/encoding', 'panel/admin/settings/cron-job', 'panel/admin/websockets'])) active @endif" 
                  @if (request()->is(['panel/admin/settings', 'panel/admin/settings/limits', 'panel/admin/video/encoding', 'panel/admin/settings/cron-job', 'panel/admin/websockets'])) aria-expanded="true" @endif>
                      <i class="bi-gear me-2"></i> {{ __('admin.general_settings') }}
                  </a>
              </li><!-- /end list -->
            @endif

              <div class="collapse w-100 @if (request()->is(['panel/admin/settings', 'panel/admin/settings/limits', 'panel/admin/video/encoding', 'panel/admin/settings/cron-job', 'panel/admin/websockets'])) show @endif ps-3" id="settings">
                <li>
