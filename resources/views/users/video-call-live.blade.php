...
<body>
    ...
    async function initializeAgora() {
        ...
        try {
            console.log(1111)
            await rtc.client.join("11c51e3e019b471f9012c1bb2e8a741f", "toinv", "007eJxTYEhk0k98JH7WqOxRgOX+p5snM8sVymYtCvgz7cXfXq6uXdsVGAwNk00NU41TDQwtk0zMDdMsDQyNkg2TkoxSLRLNTQzTolTCMhoCGRnsu7xZGRkgEMRnZSjJz8wrY2AAADIvHrk=", null);
            ...
            if (desktopConnectingElement) desktopConnectingElement.innerText = "Error al conectar: " + error.message;
            if (mobileConnectingElement) mobileConnectingElement.innerText = "Error al conectar: " + error.message;
        }
    }
